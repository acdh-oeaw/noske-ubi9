...
RUN --mount=type=cache,target=/sources \
    ...
    curl -LO https://corpora.fi.muni.cz/noske/current/centos7/bonito-open/bonito-open-5.71.15.el7.src.rpm && \
    curl -LO https://corpora.fi.muni.cz/noske/current/centos7/gdex/gdex-4.13.2-1.el7.src.rpm && \
    curl -LO https://corpora.fi.muni.cz/noske/current/centos7/crystal-open/crystal-open-2.166.4.el7.src.rpm && \
